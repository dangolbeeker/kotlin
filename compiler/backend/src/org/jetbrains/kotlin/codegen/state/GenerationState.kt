...
class GenerationState private constructor(
    ...
    val runtimeStringConcat =
        if (target.bytecodeVersion >= JvmTarget.JVM_9.bytecodeVersion) configuration.get(JVMConfigurationKeys.RUNTIME_STRING_CONCAT)
            ?: JvmRuntimeStringConcat.DISABLE else JvmRuntimeStringConcat.DISABLE
