...
private fun BaseGradleIT.transformNativeTestProjectWithPluginDsl(projectName: String, directoryPrefix: String? = null): BaseGradleIT.Project {
    val project = transformProjectWithPluginsDsl(projectName, directoryPrefix = directoryPrefix)
    project.configureSingleNativeTarget()
    project.configureMemoryInGradleProperties()
    return project
}
